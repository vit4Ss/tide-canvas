...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  ...
  if (pathname.startsWith("/user/assets") || pathname.startsWith("/user/projects")) {
    return (
      <div className={(sidebarCollapsed ? "lg:pl-[72px]" : "lg:pl-[208px]") + " min-h-screen bg-white text-neutral-950 transition-[padding] duration-300 ease-out dark:bg-neutral-950 dark:text-neutral-50"}>
