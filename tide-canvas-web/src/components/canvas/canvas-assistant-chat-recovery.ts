...
/** A lookup failure is terminal only when the server explicitly says the task is inaccessible/missing. */
...
/** Synchronous durability barrier used immediately before the first paid POST. */
