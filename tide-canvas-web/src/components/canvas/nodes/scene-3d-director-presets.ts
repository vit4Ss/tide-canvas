...
export interface CharacterPresetDefinition {
  ...
  defaultScale: number;
  color: number;
  /** 头部骨骼独立缩放：儿童/二头身要更大的头身比，等比缩小只会得到"迷你成年人"。 */
  headScale?: number;
}
...
export const CHARACTER_PRESETS: readonly CharacterPresetDefinition[] = [
  ...
  { key: "athletic", label: "健硕", bodyScale: [1.12, 1.02, 1.06], defaultScale: 1.02, color: 0x22c55e, headScale: 0.94 },
  { key: "slim", label: "纤细", bodyScale: [0.82, 1.03, 0.84], defaultScale: 1, color: 0xa855f7, headScale: 1.04 },
  { key: "teen", label: "少年", bodyScale: [0.9, 0.94, 0.9], defaultScale: 0.92, color: 0x14b8a6, headScale: 1.08 },
  { key: "child", label: "儿童", bodyScale: [0.86, 0.82, 0.88], defaultScale: 0.78, color: 0xf59e0b, headScale: 1.24 },
  { key: "broad", label: "宽厚", bodyScale: [1.2, 1, 1.1], defaultScale: 1.02, color: 0xef4444, headScale: 0.92 },
  { key: "chibi", label: "二头身", bodyScale: [1.22, 0.7, 1.12], defaultScale: 0.72, color: 0x8b5cf6, headScale: 1.62 },
] as const;
