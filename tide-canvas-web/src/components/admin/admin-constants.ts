...
export const ADMIN_ICONS: Record<string, string> = {
  ...
  style:
    "M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.9 0 1.6-.75 1.6-1.7 0-.44-.17-.83-.44-1.12-.26-.3-.43-.68-.43-1.12A1.63 1.63 0 0 1 14.4 16.4h1.96c3.05 0 5.56-2.5 5.56-5.55C21.9 6 17.46 2 12 2zM8.5 7.5h.01M13.5 6.5h.01M17.5 10.5h.01M6.5 12.5h.01",
  ...
  wallet: "M20 7V6a2 2 0 0 0-2-2H5a3 3 0 0 0 0 6h15v10H5a3 3 0 0 1-3-3V7M16 14h2",
