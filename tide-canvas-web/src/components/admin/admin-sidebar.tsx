...
export const ADMIN_NAV: AdminNavEntry[] = [
  ...
  { label: "分析记录", href: "/admin/analysis-records", icon: "chart", perm: "analysis_records", description: "内容分析与视频下载的用户活动记录" },
  ...
  { label: "AI 聊天供应商", href: "/admin/chat-providers", icon: "model", perm: "models", description: "对话接口（Codex 等客户端）直连的第三方服务、备用地址与模型单价" },
  { label: "API 调用记录", href: "/admin/chat-usage", icon: "chart", perm: "models", description: "用户 API Key 调用 AI 聊天供应商的 Token、积分与耗时" },
  ...
  { group: "商业" },
  { label: "激活码", href: "/admin/activation-codes", icon: "ticket", perm: "activation_codes", description: "批量生成、领取额度、到期与兑换追踪" },
